  ...
  <div className='app__footer section__padding' id='footer'>
    ...
    <div className='app__footer-links'>
      <div className='app__footer-links_contact'>
          ...
          <p className='p__opensans'>1, Adedamola Avenue, Jericho, Ibadan</p>
          <p className='p__opensans'>+1 212-344-1240</p>
          <p className='p__opensans'>+1 212-344-5240</p>
          <p className='p__opensans'>+1 212-344-7350</p>
      </div>
